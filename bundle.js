...
window.compressBenchmark = function (event) {
  ...
  var _loop = function _loop(i) {
    new _compressorjs["default"](selectedFile, {
      quality: 0.1 * i,
      mimeType: 'image/jpeg',
      success: function success(file) {
        ...
        image.width = 500;
        document.body.appendChild(image); //Append a quality description

        var quality = document.createElement('h6');
...
var simpleSubmission = function simpleSubmission(selectedFile) {
  var fd = new FormData(); //You have to user this

  new _compressorjs["default"](selectedFile, {
    quality: 0.6,
    mimeType: 'image/jpeg',
    success: function success(file) {
      fd.append('file', file, selectedFile.name); //you can use any request library tha you want
